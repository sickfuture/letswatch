...
//TODO merge with crewhlist adapter
public class CastHListAdapter extends HListCursorAdapter {
	...
	public void bindData(View view, Context context, Cursor c, ViewHolder holder) {
		RecyclingImageView imageView = (RecyclingImageView) holder
				.getViewById(IMAGE);
		String path = c.getString(c.getColumnIndex(CastProvider.PERSON_PROFILE_PATH));
		...
		String title = c.getString(c.getColumnIndex(CastProvider.PERSON_NAME));
