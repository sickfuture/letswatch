...
public class SearchedPersonsProvider extends CommonProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		String sql = new SQLQueryBuilder()
				...
				.where(String.format("%s.%s = %s.%s", personTable,
						Contract.PersonColumns.TMDB_ID, childTable,
						Contract.SearchedPersonsColumns.PERSON_ID)).getSql();
	...
	protected Class<?> getContractClass() {
		return Contract.SearchedPersonsColumns.class;
	}
